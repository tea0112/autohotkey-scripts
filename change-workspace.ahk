;You can switch to any of these desktops 
;using the keyboard shortcuts defined in the script. 
;Hold down Windows key(or CapsLock depending on your setting) 
;and press a number between 1 and 9, 
;and you are automatically switched to that numbered desktop. 
;For instance, press Windows key+3 to switch to 
;the third virtual desktop from the left.
;
; Globals
